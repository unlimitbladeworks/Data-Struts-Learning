 ...
 * @author suyu
 * @version 1.0.0
 * @ClassName ArrayDynTimeComplexity（改版，变为动态数组） 数组篇
 * @Description 慕课实战--数据结构篇 数组的resize复杂度分析,均摊复杂度 以及防止复杂度震荡
 * @Date 2018年4月25日21:55:26
 */
public class ArrayDynTimeComplexity<E> {
     ...
     * @param capacity
     */
    public ArrayDynTimeComplexity(int capacity) {
        //不能直接new 泛型,如下
        //data = new E[capacity];
        //只能通过Object来创建进行强转了
